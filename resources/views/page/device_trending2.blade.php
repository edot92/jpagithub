...
<script src="http://github.highcharts.com/f808ab117823082ca137fab775cbdf52cce27b90/modules/exporting.src.js"></script>
...
$.ajax({
	...
	for(x=0;x<panjangJson;x++){
		...
		valueWaktu[x]=msg[x].waktu;//konvert ke int
     ...
     chartVoltage=new  $('#container_voltage').highcharts();
      ...
      chartVoltage.series[3].setData(valueVtot,false);
       ...
       // chartVoltage.yAxis[0].max= panjangJson;
        ...
        chartVoltage.xAxis[0].isDirty = true;
     		       chartVoltage.redraw();
   // Phase_1_Voltage_LN
